...
| [`SQLite.Framework.Maui`](https://github.com/destbg/SQLite.Framework/tree/main/Sample/SQLite.Framework.Maui) | Full .NET MAUI app (Android / iOS / Mac Catalyst / Windows). Demonstrates a setup for mobile: singleton database, MVVM with `CommunityToolkit.Mvvm`. | `dotnet build -t:Run -f net10.0-android Sample/SQLite.Framework.Maui` |
