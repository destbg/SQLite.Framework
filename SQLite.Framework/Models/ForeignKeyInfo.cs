...
public class ForeignKeyInfo
{
    ...
    /// <summary>
    /// Writes the SQL fragment for this constraint without leading or trailing whitespace.
    /// </summary>
    public void WriteSql(StringBuilder sb, bool inline)
    {
        if (inline)
        {
        ...
        AppendAction(sb, " ON DELETE ", OnDelete);
        AppendAction(sb, " ON UPDATE ", OnUpdate);
        if (Deferred)
        {
