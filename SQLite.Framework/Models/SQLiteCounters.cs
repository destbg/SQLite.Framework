...
public class SQLiteCounters
{
    ...
    /// <summary>
    /// Returns true if the given parameter name is reserved and should not be generated by this counter.
    /// </summary>
    public bool IsReservedParamName(string name)
    {
        return reservedParamNames != null && reservedParamNames.Contains(name);
    }
