...
internal static class TypeHelpers
{
    ...
    public static SQLiteColumnType TypeToSQLiteType(Type type, SQLiteOptions options)
    {
        ...
        return type switch
        {
            ...
            _ when type == typeof(TimeSpan) && options.TimeSpanStorage == TimeSpanStorageMode.Text => SQLiteColumnType.Text,
            ...
            _ when type.IsEnum && options.EnumStorage == EnumStorageMode.Text => SQLiteColumnType.Text,
