...
public class FullTextSearchEscapingTests
{
    ...
    public void Term_BareAlphanumeric_EmitsBareAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("aot")));
    ...
    public void Term_WithDigits_EmitsBareAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("v9")));
    ...
    public void Term_AllDigits_EmitsBareAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("2024")));
    ...
    public void Term_WithUnderscore_EmitsBareAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("hello_world")));
    ...
    public void Term_WithSpace_GetsQuotedAndMatchesPhrase()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("hello world")));
    ...
    public void Term_WithSingleQuote_GetsQuotedAndMatchesAdjacentTokens()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("foo'bar")));
    ...
    public void Term_MixedQuoteChars_OnlyDoubleQuoteIsDoubledAndMatchesAdjacentTokens()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("a\"b'c`d")));
    ...
    public void Term_Empty_GetsQuotedAsEmptyTokenAndMatchesNothing()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("")));
    ...
    public void Term_UppercaseAnd_GetsQuotedAndMatchesLowercased()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("AND")));
    ...
    public void Term_UppercaseOr_GetsQuotedAndMatchesLowercased()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("OR")));
    ...
    public void Term_UppercaseNot_GetsQuotedAndMatchesLowercased()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("NOT")));
    ...
    public void Term_UppercaseNear_GetsQuotedAndMatchesLowercased()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("NEAR")));
    ...
    public void Phrase_Plain_GetsQuotedAndMatchesAdjacent()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("native aot")));
    ...
    public void Phrase_BareWord_StillGetsQuotedAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("native")));
    ...
    public void Phrase_WithDoubleQuote_DoublesInnerQuoteAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("said \"hi\"")));
    ...
    public void Phrase_WithSingleQuote_PassesThroughAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("it's fine")));
    ...
    public void Phrase_WithBacktick_PassesThroughAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("foo`bar")));
    ...
    public void Phrase_Empty_GetsEmptyQuotesAndMatchesNothing()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Phrase("")));
    ...
    public void Prefix_Bare_AppendsStarAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Prefix("nativ")));
    ...
    public void Prefix_NeedsQuoting_QuotesAndAppendsStarAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Prefix("hello world")));
    ...
    public void Near_PlainTerms_EmitsBareTokensAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Near(2, "ahead", "time")));
    ...
    public void Near_TermWithSpace_QuotesItAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Near(5, "hello world", "foo")));
    ...
    public void Near_TermWithDoubleQuote_DoublesQuoteAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Near(3, "a\"b", "c")));
    ...
    public void And_TwoTerms_JoinsWithAndAndMatchesBoth()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("alpha") && f.Term("beta")));
    ...
    public void Not_StandaloneUnary_Throws()
    {
        ...
        NotSupportedException ex = Assert.Throws<NotSupportedException>(() =>
            db.Table<ArticleSearch>()
                .Where(a => SQLiteFTS5.Match(a, f => !f.Term("a")))
                .ToSqlCommand());
    ...
    public void Precedence_AndOverOr_DoesNotParenthesizeAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Term("alpha") || f.Term("beta") && f.Term("gamma")));
    ...
    public void Column_StaticTerm_EmitsColumnScopeAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Column(a.Title, f.Term("native"))));
    ...
    public void Column_TermWithSpace_QuotesInsideScopeAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Column(a.Title, f.Term("hello world"))));
    ...
    public void Column_OrInsideScope_WrapsWithParensAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Column(a.Title, f.Term("alpha") || f.Term("beta"))));
    ...
    public void StringForm_PassesQueryThroughUnchangedAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, "native AND \"aot ready\""));
    ...
    public void StringForm_ColumnScoped_WrapsInColumnPrefixAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a.Title, "native"));
    ...
    public void Dynamic_StaticAndDynamicTerms_ConcatenatesViaPipesAndMatches()
    {
        ...
        SQLiteCommand cmd = (
            ...
            where SQLiteFTS5.Match(s, f => f.Term("native") && f.Term(a.Title))
    ...
    public void Dynamic_DynamicPrefix_AppendsLiteralStarAndMatches()
    {
        ...
        SQLiteCommand cmd = (
            from s in db.Table<ArticleSearch>()
            join a in db.Table<Article>() on s.Id equals a.Id
            where SQLiteFTS5.Match(s, f => f.Prefix(a.Title))
            select s.Id).ToSqlCommand();
    ...
    public void Dynamic_DynamicPhrase_UsesPrintfWrapperAndMatches()
    {
        ...
        SQLiteCommand cmd = (
            from s in db.Table<ArticleSearch>()
            join a in db.Table<Article>() on s.Id equals a.Id
            where SQLiteFTS5.Match(s, f => f.Phrase(a.Title))
            select s.Id).ToSqlCommand();
    ...
    public void Dynamic_NearWithDynamicTerm_WrapsOnlyDynamicTermsAndMatches()
    {
        ...
        SQLiteCommand cmd = (
            from s in db.Table<ArticleSearch>()
            join a in db.Table<Article>() on s.Id equals a.Id
            where SQLiteFTS5.Match(s, f => f.Near(2, a.Title, "static"))
            select s.Id).ToSqlCommand();
    ...
    public void RoundTrip_DynamicTermWithDoubleQuote_FindsRow()
    {
        ...
        var hits = (
                from s in db.Table<ArticleSearch>()
                join a in db.Table<Article>() on s.Id equals a.Id
                where SQLiteFTS5.Match(s, f => f.Term(a.Title))
                select s.Id)
            .ToList();
    ...
    public void RoundTrip_TermWithDoubleQuote_StaticConstant_FindsNothingForTokenizedColumn()
    {
        ...
        var hits = db.Table<ArticleSearch>()
            .Where(a => SQLiteFTS5.Match(a, f => f.Term("hello\"world")))
            .ToList();
    ...
    public void Near_TermsFromVariable_EvaluatesArrayConstantAndMatches()
    {
        ...
        Func<IQueryable<ArticleSearch>, IQueryable<ArticleSearch>> shape = q => q.Where(a => SQLiteFTS5.Match(a, f => f.Near(2, terms)));
    ...
    public void Match_UnsupportedExpression_Throws()
    {
        ...
        NotSupportedException ex = Assert.Throws<NotSupportedException>(() =>
            db.Table<ArticleSearch>()
                .Where(a => SQLiteFTS5.Match(a, f => a.Title == "x"))
                .ToSqlCommand());

        Assert.Contains("Unsupported expression inside SQLiteFTS5.Match", ex.Message);
    }
    ...
    public void Match_BooleanLiteralBody_Throws()
    {
        ...
        NotSupportedException ex = Assert.Throws<NotSupportedException>(() =>
            db.Table<ArticleSearch>()
                .Where(a => SQLiteFTS5.Match(a, f => true))
                .ToSqlCommand());
    ...
    public void Column_StringLiteral_Throws()
    {
        ...
        NotSupportedException ex = Assert.Throws<NotSupportedException>(() =>
            db.Table<ArticleSearch>()
                .Where(a => SQLiteFTS5.Match(a, f => f.Column("Title", f.Term("native"))))
                .ToSqlCommand());
    ...
    public void Match_DynamicTermFromUnresolvableExpression_Throws()
    {
        ...
        NotSupportedException ex = Assert.Throws<NotSupportedException>(() =>
            (from s in db.Table<ArticleSearch>()
             join a in db.Table<Article>() on s.Id equals a.Id
             where SQLiteFTS5.Match(s, f => f.Term(a.Title.ToString()))
             select s.Id).ToSqlCommand());
