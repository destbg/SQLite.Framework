...
public class TerminalContainsNullTests
{
    ...
    [Fact]
    public void ContainsNull_WithNullRow_MatchesLinqToObjects()
    {
    ...
    [Fact]
    public void ContainsNull_WithoutNullRow_MatchesLinqToObjects()
    {
    ...
    [Fact]
    public void ContainsNull_EmptyTable_MatchesLinqToObjects()
    {
    ...
    [Fact]
    public void ContainsNonNull_WithNullRow_StillMatches()
    {
        (int id, int? value)[] rows = [(1, null), (2, 5)];
        using TestDatabase db = SeedInts(rows);
    ...
    [Fact]
    public async Task ContainsAsyncNull_WithNullRow_MatchesLinqToObjects()
    {
        (int id, int? value)[] rows = [(1, null), (2, 5)];
        using TestDatabase db = SeedInts(rows);
    ...
    [Fact]
    public async Task ContainsAsyncNull_WithoutNullRow_MatchesLinqToObjects()
    {
        (int id, int? value)[] rows = [(1, 5), (2, 7)];
        using TestDatabase db = SeedInts(rows);
    ...
    [Fact]
    public void ContainsNullString_WithNullRow_MatchesLinqToObjects()
    {
