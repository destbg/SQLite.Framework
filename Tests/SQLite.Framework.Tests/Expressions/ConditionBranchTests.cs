...
public class ConditionBranchTests
{
    ...
    public void Array_Exists_PredicateWithoutCapturedParameters_DoesNotPanic()
    {
        using TestDatabase db = new(b =>
        {
            b.TypeConverters[typeof(string[])] =
                new SQLiteJsonConverter<string[]>(SupplementalJsonContext.Default.StringArray);
        });
    ...
    private static TestDatabase MakeJsonDb()
    {
        TestDatabase db = new(b =>
        {
            b.TypeConverters[typeof(List<string>)] =
                new SQLiteJsonConverter<List<string>>(SupplementalJsonContext.Default.ListString);
        });
...
internal partial class SupplementalJsonContext : System.Text.Json.Serialization.JsonSerializerContext;
