...
public class SupplementalQueryTests
{
    [Fact]
    ...
    public void Upsert_DoUpdateAll_AllColumnsAreConflict_EmitsDoNothing()
    {
        ...
        Assert.Equal("INSERT INTO \"Books\" (\"BookId\", \"BookTitle\", \"BookAuthorId\", \"BookPrice\") VALUES (@p0, @p1, @p2, @p3) ON CONFLICT (\"BookId\", \"BookTitle\", \"BookAuthorId\", \"BookPrice\") DO NOTHING", sql);
    }
    ...
    public void Functions_Regexp_TranslatesToSqlRegexpOperator()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE (b0.\"BookTitle\" REGEXP @p0)", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Functions_Match_StringColumnOverload_BuildsScopedMatch()
    {
        ...
        Assert.Equal("SELECT a0.\"rowid\" AS \"Id\",\n       a0.\"Title\" AS \"Title\",\n       a0.\"Body\" AS \"Body\"\nFROM \"ArticleSearch\" AS a0\nWHERE \"ArticleSearch\" MATCH @p0", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Int_ToString_TranslatesToCastAsText()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE CAST(b0.\"BookAuthorId\" AS TEXT) = @p0", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Int_Parse_TranslatesToCastAsInteger()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE CAST(b0.\"BookTitle\" AS INTEGER) > @p0", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Double_Parse_TranslatesToCastAsReal()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE CAST(b0.\"BookTitle\" AS REAL) > @p0", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Snippet_DynamicAuxArgs_WrapInPrintf()
    {
        ...
        Assert.Equal("SELECT snippet(\"ArticleSearch\", 0, @p1, @p2, @p3, @p4) AS \"9\"\nFROM \"ArticleSearch\" AS a0\nWHERE \"ArticleSearch\" MATCH @p0", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void FtsMatch_DynamicTerm_ProducesPrintfWrappedSql()
    {
        ...
        Assert.Equal("SELECT a0.\"rowid\" AS \"Id\",\n       a0.\"Title\" AS \"Title\",\n       a0.\"Body\" AS \"Body\"\nFROM \"ArticleSearch\" AS a0\nWHERE \"ArticleSearch\" MATCH (printf('\"%w\"', a0.\"Title\") || @p0)", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Enum_NonGenericParse_WithTypeArgument_TranslatesToCase()
    {
        ...
        Assert.Equal("SELECT p0.\"Id\" AS \"Id\",\n       p0.\"Name\" AS \"Name\",\n       p0.\"Type\" AS \"Type\"\nFROM \"Publisher\" AS p0\nWHERE p0.\"Type\" = CAST((SELECT (CASE v5 WHEN @p2 THEN 1 WHEN @p3 THEN 2 WHEN @p4 THEN 3 WHEN @p5 THEN 4 ELSE CAST(v5 AS INTEGER) END) FROM (SELECT @p1 AS v5)) AS INTEGER)", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Enum_ToString_TranslatesToCaseExpression()
    {
        ...
        Assert.Equal("SELECT p0.\"Id\" AS \"Id\",\n       p0.\"Name\" AS \"Name\",\n       p0.\"Type\" AS \"Type\"\nFROM \"Publisher\" AS p0\nWHERE (SELECT (CASE v3 WHEN 1 THEN @p0 WHEN 2 THEN @p1 WHEN 3 THEN @p2 WHEN 4 THEN @p3 ELSE CAST(v3 AS TEXT) END) FROM (SELECT p0.\"Type\" AS v3)) = @p4", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Subquery_Contains_BuildsInClause()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE EXISTS (\nSELECT 1 FROM (\n    SELECT a1.\"AuthorId\" AS \"Id\"\n    FROM \"Authors\" AS a1\n) WHERE \"Id\" IS b0.\"BookAuthorId\")", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Trim_WithCharArrayLiteral_TranslatesToTrim()
    {
        ...
        Assert.Equal("SELECT b0.\"BookId\" AS \"Id\",\n       b0.\"BookTitle\" AS \"Title\",\n       b0.\"BookAuthorId\" AS \"AuthorId\",\n       b0.\"BookPrice\" AS \"Price\"\nFROM \"Books\" AS b0\nWHERE TRIM(b0.\"BookTitle\", @p1 || @p2) = @p3", cmd.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void Enum_HasFlag_TranslatesToBitwiseAnd()
    {
        ...
        Assert.Equal("SELECT p0.\"Id\" AS \"Id\",\n       p0.\"Name\" AS \"Name\",\n       p0.\"Type\" AS \"Type\"\nFROM \"Publisher\" AS p0\nWHERE ((p0.\"Type\" & @p0) = @p0)", cmd.CommandText.Replace("\r\n", "\n"));
    }
...
#pragma warning restore xUnit1031 // Do not use blocking task operations in test method
    ...
    public void Join_WithComputedMethodCallAssignment_ProducesCorrectSql()
    {
        ...
        Assert.Equal("SELECT UPPER(b0.\"BookTitle\") AS \"UpperTitle\",\n       a1.\"AuthorName\" AS \"AuthorName\"\nFROM \"Books\" AS b0\nJOIN \"Authors\" AS a1 ON b0.\"BookAuthorId\" = a1.\"AuthorId\"", command.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void VisitUnary_CastIntToChar_ProducesCharFunction()
    {
        ...
        Assert.Equal("SELECT CHAR((b0.\"BookId\") & 65535) AS \"5\"\nFROM \"Books\" AS b0", command.CommandText.Replace("\r\n", "\n"));
    }
    ...
    public void VisitUnary_CastToGenericType_ProducesCast()
    {
        ...
        Assert.Equal("SELECT CAST(b0.\"BookPrice\" AS INTEGER) AS \"5\"\nFROM \"Books\" AS b0", command.CommandText.Replace("\r\n", "\n"));
    }
    ...
    {
        MethodInfo method = typeof(SupplementalQueryTests)
