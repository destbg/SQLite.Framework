...
public class SchemaDeclarationBugTests
{
    ...
    public void CompositePrimaryKeyHonorsDeclaredColumnOrder()
    {
        ...
        Assert.Contains("PRIMARY KEY (\"Code\", \"Id\")", TableSql(db, "BugCompKey"));
    }
    ...
    public void IndexedColumnsWithSameNameOnDifferentTablesBothGetIndexes()
    {
        ...
        long indexesOnB = db.ExecuteScalar<long>(
            "SELECT count(*) FROM sqlite_master WHERE type = 'index' AND tbl_name = 'BugIdxB' AND sql IS NOT NULL");
