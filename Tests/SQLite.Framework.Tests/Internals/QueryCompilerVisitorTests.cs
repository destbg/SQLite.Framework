...
public class QueryCompilerVisitorTests
{
    ...
    {
        NumericValueHolder a = new(3m);
        NumericValueHolder b = new(5m);

        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryAdditionOperator"), a, b, TestOptions]);

        Assert.Equal(new NumericValueHolder(8m), result);
    }
#endif
    ...
    {
        NumericValueHolder a = new(10m);
        NumericValueHolder b = new(3m);

        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinarySubtractionOperator"), a, b, TestOptions]);

        Assert.Equal(new NumericValueHolder(7m), result);
    }
#endif
    ...
    {
        NumericValueHolder a = new(4m);
        NumericValueHolder b = new(6m);

        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryMultiplyOperator"), a, b, TestOptions]);

        Assert.Equal(new NumericValueHolder(24m), result);
    }
#endif
    ...
    {
        NumericValueHolder a = new(20m);
        NumericValueHolder b = new(4m);

        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryDivisionOperator"), a, b, TestOptions]);

        Assert.Equal(new NumericValueHolder(5m), result);
    }
#endif
    ...
    public void InvokeOperator_ModulusOnCustomStruct_GoesThroughGenericFallback()
    {
        ...
        Assert.Equal(new NumericValueHolder(1m), result);
    }
#endif
    ...
    {
        NumericValueHolder value = new(7m);
    ...
    {
        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryBitwiseAndOperator"), new ShiftableValueHolder(12), new ShiftableValueHolder(10), TestOptions]);

        Assert.Equal(new ShiftableValueHolder(8), result);
    }
#endif
    ...
    {
        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryBitwiseOrOperator"), new ShiftableValueHolder(12), new ShiftableValueHolder(10), TestOptions]);

        Assert.Equal(new ShiftableValueHolder(14), result);
    }
#endif
    ...
    {
        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryExclusiveOrOperator"), new ShiftableValueHolder(12), new ShiftableValueHolder(10), TestOptions]);

        Assert.Equal(new ShiftableValueHolder(6), result);
    }
#endif
    ...
    {
        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryLeftShiftOperator"), new ShiftableValueHolder(3), 2, TestOptions]);

        Assert.Equal(new ShiftableValueHolder(12), result);
    }
#endif
    ...
    {
        object? result = InvokeOperator.Invoke(null, [GetOpenMethod("BinaryRightShiftOperator"), new ShiftableValueHolder(12), 2, TestOptions]);

        Assert.Equal(new ShiftableValueHolder(3), result);
    }
#endif
#endif
    ...
    {
        NotComparableValueHolder left = new(1);
        NotComparableValueHolder right = new(2);
    ...
    {
        QueryCompilerVisitor visitor = new(TestOptions);
        MemberInfo member = typeof(SupplementalBindTarget).GetProperty(nameof(SupplementalBindTarget.Value))!;
    ...
    {
        QueryCompilerVisitor visitor = new(TestOptions);
        PropertyInfo prop = typeof(SupplementalBindTarget).GetProperty(nameof(SupplementalBindTarget.Value))!;
    ...
    {
        QueryCompilerVisitor visitor = new(TestOptions);
        PropertyInfo prop = typeof(SupplementalBindTarget).GetProperty(nameof(SupplementalBindTarget.List))!;
        MethodInfo addMethod = typeof(List<int>).GetMethod(nameof(List<int>.Add))!;
    ...
    {
        QueryCompilerVisitor visitor = new(TestOptions);
        PropertyInfo nested = typeof(SupplementalBindTarget).GetProperty(nameof(SupplementalBindTarget.Nested))!;
        PropertyInfo nestedValue = typeof(SupplementalBindTargetNested).GetProperty(nameof(SupplementalBindTargetNested.Value))!;
...
public sealed class SupplementalBindTarget
{
    public int Value { get; set; }
    public SupplementalBindTargetNested Nested { get; set; } = new();
    public List<int> List { get; set; } = [];
}

public sealed class SupplementalBindTargetNested
{
    public int Value { get; set; }
}
