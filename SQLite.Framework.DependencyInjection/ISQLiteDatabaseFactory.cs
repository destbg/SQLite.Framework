...
/// <summary>
/// Produces fresh <typeparamref name="TDatabase" /> instances on demand.
/// Use this when a single DI scope needs more than one <see cref="SQLiteDatabase" />
/// instance (e.g. a background worker that iterates items and wants a short-lived database per item).
/// </summary>
